# Project Overview
Full-stack application, similar in concept to X (Twitter), using Next.js for both the frontend and backend. 
The architecture follows the repository pattern to centralize and abstract the data layer, ensuring a clear separation between business logic and database communication.
